...
/**
 * class to load available images in db
 */
class AllImagesRepository(private val dao: ImagesDao) : ImageRepository {

    override fun getImages(): LiveData<PagedList<ImageModel>> = dao.allImages().toLiveData(
        pagedListConfig()
    )
}